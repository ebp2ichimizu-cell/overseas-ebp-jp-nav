...
- stop check時に自転車登録を照会
- warrant実施時に照会
- 警察保管自転車の受入時に照会
- 処分前にも再照会
- 自転車関連事件について犯罪 Demand Unitが照会
- 被害者へ登録・盗難登録状態変更を案内
...
販売店を訪問・訓練し、
購入時（購入時点（販売時点））に登録・マーキングできる体制を作る。

## 4．指示するだけでなく、実施状況を追跡する（指示・割当だけでなく実施追跡）
...
自転車登録を、
マーキングだけでなく照会、被害届、押収物、学校、販売店、ダッシュボードへ組み込んだ。

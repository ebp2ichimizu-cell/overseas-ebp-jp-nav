...
単発研修だけではなく、
日常の簡易説明（ブリーフィング）やフィードバックで繰り返す必要があります。
...
同じ大きさの地理単位を比較し、
犯罪件数／犯罪被害の深刻度（犯罪 / 被害の重大性）の集中が最も高い場所から優先します。
...
対策が違えば必要な介入量（dose）も変わります。

4．指示・割当だけでなく実施状況の追跡（実施追跡）を用意する

...
7つのserious violence hot spotsを特定。
...
- GPSを使ったフィードバック（feedback）が重要
- 対面（face-to-face）の計画・調整が有効
- 介入忠実度（treatment fidelity）を高めるのに時間がかかった
...
「街頭アウトリーチ（street outreach）を40分配置すれば犯罪が39％減る」

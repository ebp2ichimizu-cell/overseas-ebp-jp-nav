...
このテーマでは、
Effectと実装を一緒に見ることが特に重要です。

犯罪が減った／減らなかった
だけでなく、

「どれだけのtargetへ対策が実装されたか」
...
比較地域を用いたquasi-experimental evaluation等。

Toolkitは、
住宅侵入窃盗研究ではrandomised allocationを用いた研究はなかったと整理しています。

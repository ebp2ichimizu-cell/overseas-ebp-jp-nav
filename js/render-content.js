...
function shell(title,url,original){
...
export function renderCase(data,id){
  ...
  return shell(
    item.title_ja,
    item.commentary_slug ? `./content/cases/ja/${item.commentary_slug}.md` : "",
    item.original_url
  );
}
...
export function renderTranslation(data,id){
  ...
  return shell(
    item.title_ja,
    item.content_slug ? `./content/translations/ja/${item.content_slug}.md` : "",
    item.original_url
  );
}
